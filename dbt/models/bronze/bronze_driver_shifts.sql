...
WITH source AS (
    SELECT
        ...
        RECORD_CONTENT:shift_duration_min::INT               AS shift_duration_min,
        RECORD_CONTENT:num_orders::INT                       AS num_orders,
        RECORD_CONTENT:distance_covered_km::FLOAT            AS distance_covered_km,
        RECORD_CONTENT:earnings_brl::FLOAT                   AS earnings_brl,
        RECORD_CONTENT:shift_rating::FLOAT                   AS shift_rating,
        RECORD_CONTENT:issues_reported::INT                  AS issues_reported,
