...
register_connector "snowflake-sink"         "${CONNECTORS_DIR}/snowflake_sink.json"
register_connector "snowflake-sink-items"   "${CONNECTORS_DIR}/snowflake_sink_items.json"
...
for connector in debezium-postgres-cdc snowflake-sink snowflake-sink-items; do
